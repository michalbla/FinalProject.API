...
namespace TNAI_FinalProject.API.Migrations
{
    ...
    [Migration("20250104183750_UserDetails-fixed")]
    partial class UserDetailsfixed
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TNAI_FinalProject.Model.Entities.UserDetails", b =>
                {
                    ...
                    b.Property<int>("ChilldrenCount")
                        .HasColumnType("int");

                    b.Property<bool>("HasChilldren")
                        .HasColumnType("bit");

                    b.Property<bool>("IsHandicaped")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("TNAI_FinalProject.Model.Entities.UserDetails", b =>
                {
                    b.HasOne("TNAI_FinalProject.Model.Entities.User", "User")
                        .WithMany("Details")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
